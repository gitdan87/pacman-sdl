...
constexpr float FIXED_DT = 0.16f;               // delta time fisso usato nella logica


// Colori
#define COLOR_BACKGROUND 0, 120, 0
...
// Gameplay
constexpr float PACMAN_MOVE_INTERVAL = 0.5f; // intervallo di movimento del player (secondi tra un passo e l’altro)
constexpr float GHOST_MOVE_INTERVAL = 1.0f; // intervallo di movimento dei fantasmi
